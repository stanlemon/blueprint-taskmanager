...
export default function TermsOfService() {
  return (
    <>
      ...
      <p>
        In order to use the Service, you must be at least 18 years of age and
      ...
      <p>
        ...
        are not owned or controlled by Blueprint Task Manager.
      </p>

      <p>
        Blueprint Task Manager has no control over, and assumes no
        responsibility for, the content, privacy policies, or practices of any
        third party web sites or services. You further acknowledge and agree
        that Blueprint Task Manager shall not be responsible or liable, directly
      ...
      <p>
        ...
        made available without warranty or condition of any kind. Blueprint Task
        Manager makes no guarantee that the Service will be safe, secure, or
      ...
      <p>
        ...
        of Indiana, United States, without regard to its conflict of law
        provisions.
      </p>
      ...
      <p>
        ...
        Terms at any time without prior notice to any new terms taking effect.
      </p>
      ...
      <p>
        <em>
          This Terms of Service agreement has been created with the help of{" "}
          <a
